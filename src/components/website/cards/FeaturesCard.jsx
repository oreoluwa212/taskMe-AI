...
const FeaturesCard = ({ title, description, imageUrl, className }) => {
  return (
    <div className="bg-white shadow-lg shadow-gray-300/50 h-fit max-w-[380px] w-[90%] rounded-[8px] flex flex-col justify-center items-start text-center py-10 px-8">
      {imageUrl && (
      ...
      <p className="text-left text-gray-700 pt-2 font-semibold">{description}</p>
    </div>
  );
};
