...
const FeaturesCard = ({ title, description, imageUrl, className }) => {
  return (
    <div className="bg-white shadow-lg shadow-gray-300/50 h-fit max-w-[350px] w-[90%] rounded-[8px] flex flex-col justify-center items-start text-center py-10 pl-7 pr-3">
      {imageUrl && (
