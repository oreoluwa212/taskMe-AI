    ...
    <div className="w-full flex flex-col justify-center items-center h-fit py-20 mb-10">
      ...
      <div className="w-4/5 lg:w-3/5 text-center">
        <Section title="Our Story">
          ...
          passionate individuals who felt overwhelmed by the complexity of task
          management tools available in the market. We believe there had to be a
          better way, a simpler, more intuitive solution that could help
          individuals stay organized, productive and focused on what matters
          most.
        </Section>
