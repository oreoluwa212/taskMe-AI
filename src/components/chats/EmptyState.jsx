// src/components/chats/EmptyState.jsx
      ...
      <div className="text-center max-w-md">
        ...
        <div className="space-y-3">
          ...
          <Button
            ...
            variant="primary"
            size="lg"
            className="w-full md:w-auto px-6 py-3 text-base font-medium flex items-center justify-center space-x-2"
          >
            <Plus size={20} />
          ...
          {isMobile && hasChats && onToggleSidebar && (
            <Button
              ...
              variant="secondary"
              size="lg"
              className="w-full px-6 py-3 text-base font-medium flex items-center justify-center space-x-2"
            >
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <p className="text-xs text-gray-500">
            {hasChats
              ? `You have ${hasChats} chat${hasChats !== 1 ? "s" : ""} saved`
